...
def famarl_get_decoding_strategy(decoding_strategy, **config):
    strategy_registry = {
        "greedy": Greedy,
        "sampling": Sampling,
        "evaluate": Evaluate,
...
class FAMARLDecodingStrategy(metaclass=abc.ABCMeta):
    name = "base"
...
class Greedy(FAMARLDecodingStrategy):
    name = "greedy"
...
class Sampling(FAMARLDecodingStrategy):
    name = "sampling"
...
class Evaluate(FAMARLDecodingStrategy):
    name = "evaluate"
