...
from famarl.models.env_embeddings import env_init_embedding
from famarl.models.nn.matnet import MatNetLayer
from famarl.models.nn.transformer import Normalization, TransformerBlock


class FAMARLEncoder(nn.Module):
    def __init__(
        self,
        env_name: str = "hcvrp",
        num_heads: int = 8,
        ...
        **transformer_kwargs,
        ...
        super(FAMARLEncoder, self).__init__()
