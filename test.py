...
from famarl.envs import  HCVRPEnv
from famarl.models import PARCORLModule
from famarl.tasks.eval import get_dataloader
...
if __name__ == "__main__":
    ...
    if checkpoint_path is None:
        ...
        checkpoint_path = f"./checkpoints/{problem}/famarl.ckpt"
    ...
    if not os.path.exists(checkpoint_path):
        ...
        snapshot_download("ai4co/famarl", allow_patterns=["checkpoints/*"], local_dir=".")
