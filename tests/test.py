...
from famarl.envs import HCVRPEnv, OMDCPDPEnv
from famarl.models import PARCOPolicy as PARCOPolicyRouting
...
#     td_init = env.reset(td_test_data.clone())
#     td_init_test = td_init.clone()
#     famarl = PARCOMultiStagePolicy(env_name=env.name, init_embedding_kwargs={"one_hot_seed_cnt":num_machine}, num_stages=num_stage)
#     out = famarl(td_init_test.clone(), env=env)
#     assert out["reward"].shape == (2,)
